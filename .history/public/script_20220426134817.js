...
addToList = async () => {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    editButton.addEventListener("click", function (event) {
      console.log("This will eidt object:", data[i].toString());
    });
